            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 font-robotSlap">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2  md:w-2/3">
                        ...
                        <div className='text-white'>
                            ...
                            <ul className="font-medium break-words">
                                <li className="mb-4">
                                    administracion@complejoculturalrealalto.org
                                </li>
                                <li className="mb-4">
                                    info@complejoculturalrealalto.org
                                </li>
                                <li>
                                    Ubicado en la Comuna Pechiche, Parroquia Chanduy,
                                    Provincia de Santa Elena. Se llega por el desvio del kilómetro
                                    109 de la vía Guayaquil-Salinas, aproximadamente a 12 Km.
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="flex justify-center ">
                    <div className="flex mt-4 sm:mt-0">
                        ...
                        <a href="https://www.freepnglogos.com/images/whatsapp-logo-png-2272.html">Get it on whatsapp icon logo vector image black</a>
                        <a href="#" className="text-gray-500 hover:text-gray-900 ms-5">
