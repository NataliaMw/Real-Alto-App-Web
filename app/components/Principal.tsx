  ...
  return (
    <div className="relative w-[100vw] h-[90vh]">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center text-white gap-8">
        <h1 className="sm:text-3xl md:text-4xl lg:text-5xl font-erode font-semibold text-center w-[80vw] tracking-wide">CATÁLOGO ARQUEOLÓGICO INTERACTIVO DEL COMPLEJO CULTURAL REAL ALTO</h1>
        <a href="/categorias">
