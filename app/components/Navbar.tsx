        ...
        <nav className="bg-black w-screen">
            <div className="flex flex-wrap items-center justify-between md:justify-around mx-auto p-4">
                ...
                <div className={`${isMenuOpen ? 'block' : 'hidden'} w-full md:block md:w-4/5`} id="navbar-default">
                    <ul className="font-robotSlap flex flex-col justify-around w-full p-4 mt-4 
                    ...
                    md:flex-row md:p-0 md:mt-0 ">
                        ...
                        <li>
                            <a href="/contacto" className="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 text-white">CONTACTOS</a>
                        </li>
                    </ul>
                </div>
            </div>
